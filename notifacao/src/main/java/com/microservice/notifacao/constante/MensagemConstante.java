package com.microservice.notifacao.constante;
...
public class MensagemConstante {
    ...
    public static final String PROPOSTA_NEGADA_POR_STRATEGY = "Prezado(a) %s, sua proposta foi NEGADA. Nosso sistema detectou a seguinte causa: %s";
